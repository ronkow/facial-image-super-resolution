...
data = dict(
    ...
    train_dataloader=dict(
        samples_per_gpu=8, drop_last=True, persistent_workers=False), #8
...
# optimizer
optimizers = dict(generator=dict(type='Adam', lr=2e-7, betas=(0.9, 0.999)))
...
#evaluation = dict(interval=2500, save_image=False, gpu_collect=True)
