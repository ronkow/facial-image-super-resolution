...
model = dict(
    ...
    generator=dict(
        ...
        in_channels=3,
        out_channels=3,
        mid_channels=16,     # originally 64
        num_blocks=16,       # originally 23
        growth_channels=7,   # originally 32
        upscale_factor=4),

    discriminator=dict(type='ModifiedVGG', in_channels=3, mid_channels=16), # originally 64
...
data = dict(
    ...
    train_dataloader=dict(samples_per_gpu=1, drop_last=True), #32
...
#load_from = 'work_dirs/esrgan/iter_400000.pth'

load_from = None
resume_from = 'work_dirs/esrgan/iter_400000.pth'
